...
set -e
cd "$(dirname "$0")"
asr imagescan --source InstallMacOSX_10.8_Mountin_Lion.dmg
...
sudo asr restore --source InstallMacOSX_10.8_Mountin_Lion.dmg --noprompt --target "/Volumes/$target_volname" --erase
