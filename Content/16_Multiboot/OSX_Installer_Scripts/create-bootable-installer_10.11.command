...
set -e
cd "$(dirname "$0")"
asr imagescan --source InstallMacOSX_10.11_ElCapitan.dmg
...
sudo asr restore --source InstallMacOSX_10.11_ElCapitan.dmg --noprompt --target "/Volumes/$target_volname" --erase
