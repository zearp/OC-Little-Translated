...
set -e
cd "$(dirname "$0")"
asr imagescan --source InstallMacOSX_10.12_Sierra.dmg
...
sudo asr restore --source InstallMacOSX_10.12_Sierra.dmg --noprompt --target "/Volumes/$target_volname" --erase
